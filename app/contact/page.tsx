...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setFormStatus("This form isn't connected yet — real submission will be added in a later phase.");
  };
          ...
          <div className="lg:col-span-7 xl:col-span-8">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input required type="text" id="fullName" name="fullName" className="border border-[var(--color-brand-line)] px-4 py-3 bg-[var(--color-brand-white)] focus:outline-none focus:border-black transition-colors" />
              </div>

              {/* Company name */}
              <div className="flex flex-col gap-2">
                <label htmlFor="companyName" className="text-sm font-bold text-[var(--color-brand-graphite)]">Company name *</label>
                <input required type="text" id="companyName" name="companyName" className="border border-[var(--color-brand-line)] px-4 py-3 bg-[var(--color-brand-white)] focus:outline-none focus:border-black transition-colors" />
              </div>

              {/* Work email */}
              <div className="flex flex-col gap-2">
                <label htmlFor="email" className="text-sm font-bold text-[var(--color-brand-graphite)]">Work email *</label>
                <input required type="email" id="email" name="email" className="border border-[var(--color-brand-line)] px-4 py-3 bg-[var(--color-brand-white)] focus:outline-none focus:border-black transition-colors" />
              </div>

              {/* Phone / WhatsApp */}
              <div className="flex flex-col gap-2">
                <label htmlFor="phone" className="text-sm font-bold text-[var(--color-brand-graphite)]">Phone / WhatsApp *</label>
                <input required type="text" id="phone" name="phone" placeholder="Include country code" className="border border-[var(--color-brand-line)] px-4 py-3 bg-[var(--color-brand-white)] focus:outline-none focus:border-black transition-colors placeholder:text-gray-400" />
              </div>

              {/* Country / market */}
              <div className="flex flex-col gap-2">
                <label htmlFor="country" className="text-sm font-bold text-[var(--color-brand-graphite)]">Country / market *</label>
                <input required type="text" id="country" name="country" placeholder="e.g. United States" className="border border-[var(--color-brand-line)] px-4 py-3 bg-[var(--color-brand-white)] focus:outline-none focus:border-black transition-colors placeholder:text-gray-400" />
              </div>

              {/* Business type */}
              <div className="flex flex-col gap-2">
                <label htmlFor="businessType" className="text-sm font-bold text-[var(--color-brand-graphite)]">Business type *</label>
                <select required id="businessType" name="businessType" className="border border-[var(--color-brand-line)] px-4 py-3 bg-[var(--color-brand-white)] focus:outline-none focus:border-black transition-colors appearance-none">
              ...
              <div className="flex flex-col gap-2">
                ...
                <select required id="reqType" name="reqType" className="border border-[var(--color-brand-line)] px-4 py-3 bg-[var(--color-brand-white)] focus:outline-none focus:border-black transition-colors appearance-none">
                  <option value="">Select...</option>
              ...
              <div className="flex flex-col gap-2">
                ...
                <input type="text" id="carat" name="carat" className="border border-[var(--color-brand-line)] px-4 py-3 bg-[var(--color-brand-white)] focus:outline-none focus:border-black transition-colors" />
              </div>

              {/* Colour range */}
              <div className="flex flex-col gap-2">
                <label htmlFor="colour" className="text-sm font-bold text-[var(--color-brand-graphite)]">Colour range (optional)</label>
                <input type="text" id="colour" name="colour" className="border border-[var(--color-brand-line)] px-4 py-3 bg-[var(--color-brand-white)] focus:outline-none focus:border-black transition-colors" />
              </div>

              {/* Clarity range */}
              <div className="flex flex-col gap-2">
                <label htmlFor="clarity" className="text-sm font-bold text-[var(--color-brand-graphite)]">Clarity range (optional)</label>
                <input type="text" id="clarity" name="clarity" className="border border-[var(--color-brand-line)] px-4 py-3 bg-[var(--color-brand-white)] focus:outline-none focus:border-black transition-colors" />
              </div>

              {/* Approx. quantity */}
              <div className="flex flex-col gap-2">
                <label htmlFor="quantity" className="text-sm font-bold text-[var(--color-brand-graphite)]">Approx. quantity (optional)</label>
                <input type="text" id="quantity" name="quantity" className="border border-[var(--color-brand-line)] px-4 py-3 bg-[var(--color-brand-white)] focus:outline-none focus:border-black transition-colors" />
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <input type="text" id="cert" name="cert" className="border border-[var(--color-brand-line)] px-4 py-3 bg-[var(--color-brand-white)] focus:outline-none focus:border-black transition-colors" />
              </div>
              ...
              <div className="flex flex-col gap-2 md:col-span-2">
                ...
                <textarea required minLength={20} id="message" name="message" rows={5} className="border border-[var(--color-brand-line)] px-4 py-3 bg-[var(--color-brand-white)] focus:outline-none focus:border-black transition-colors resize-y"></textarea>
              </div>
              ...
              <div className="flex flex-col gap-2 md:col-span-2">
                ...
                <input type="file" id="file" name="file" accept=".pdf,.xlsx,.csv,.jpg" className="border border-[var(--color-brand-line)] px-4 py-3 bg-[var(--color-brand-white)] focus:outline-none focus:border-black transition-colors text-sm file:mr-4 file:py-2 file:px-4 file:border-0 file:text-sm file:font-medium file:bg-[var(--color-brand-panel)] file:text-[var(--color-brand-graphite)] hover:file:bg-[var(--color-brand-line)]" />
              </div>

              {/* Privacy consent - Full width */}
              <div className="flex items-start gap-3 md:col-span-2 mt-2">
                <div className="flex items-center h-5">
                  <input required id="privacy" name="privacy" type="checkbox" className="w-4 h-4 border border-[var(--color-brand-line)] rounded-none bg-[var(--color-brand-white)] accent-black" />
                </div>
              ...
              <div className="flex items-start gap-3 md:col-span-2">
                <div className="flex items-center h-5">
                  <input id="marketing" name="marketing" type="checkbox" className="w-4 h-4 border border-[var(--color-brand-line)] rounded-none bg-[var(--color-brand-white)] accent-black" />
                </div>
